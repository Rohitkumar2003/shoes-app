        ...
        <>
            ...
            >
                        ...
                        <div className="row mt-3 p-5">
                            ...
                            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                                ...
                                <hr
                                    ...
                                    style={{ width: "60px", backgroundColor: " #7c4dff", height: "2px" }}
                                />
                                <p><AiFillHome /> DEORI ROAD, AGRA UTTAR-PRADESH 282001</p>
                                <p><FaEnvelope /> Harshitenterprisesagra@gamil.com</p>
                                <p><AiFillPhone /> +91 639766307</p>
                ...
                <div className="text-center fw-light  p-3">
                    © 2026 Copyright : Harshitenterprisesagra@gamil.com
                </div>
